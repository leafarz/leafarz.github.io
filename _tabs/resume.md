...
# Summary
I'm a game developer with 11 years of experience, primarily working in Unreal Engine using both C++ and Blueprints.

I’ve worked across many areas such as game frameworks and systems, AI, UI, input, editor tools, animation, build pipelines and backend integration. I enjoy building game frameworks and systems the most.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td markdown="span">C++,  C#, Python, Typescript</td>
        </tr>
        <tr>
            <td markdown="span">Game Engines</td>
            <td markdown="span">UE5, UE4, Unity, Cocos2d-x</td>
        </tr>
        <tr>
            <td markdown="span">3D</td>
            <td markdown="span">OpenGL, DirectX12, GLSL, three.js, AFrame, Phaser</td>
        </tr>
        <tr>
            <td markdown="span">Other Tools / Libraries</td>
            <td markdown="span">.NET, Firebase, NestJs, Jenkins, Git, Perforce, SVN</td>
        </tr>
    </tbody>
</table>
...
- <div class="tag-container"><span class="co-project">Eternal League&nbsp;</span><span class="post-tag btn-outline-primary co-tag">PC</span></div>
  ...
  -  Links
     - Epic Games: <a href="https://store.epicgames.com/en-US/p/eternal-league-5e5031" target="_blank" rel="noopener noreferrer">https://store.epicgames.com/en-US/p/eternal-league-5e5031</a>
     - Steam: <a href="https://store.steampowered.com/app/3542920/Eternal_League/" target="_blank" rel="noopener noreferrer">https://store.steampowered.com/app/3542920/Eternal_League/</a>
...
- <div class="tag-container"><span class="co-project">MaaS Studio&nbsp;</span><span class="post-tag btn-outline-primary co-tag">PC</span></div>
  ...
  - Profiling and optimization of code, materials and environments. 
...
- Build security and surveillance applications using various languages and platforms 
- Code reviews, implement user stories and develop microservices. 
...
- Other activities:
  - Joined Game On! - A month long game dev competition 
    - Grav - Won 1st place (2012) 
    - Crimson - Won 1st place mobile division (2013)
